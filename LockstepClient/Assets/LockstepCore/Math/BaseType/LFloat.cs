...
namespace Lockstep
{
    ...
    public struct LFloat : IEquatable<LFloat>, IComparable<LFloat>
    {
        ...
        public const int LOCK_NUMBER_BASE = 1000;
        public const int MAX_BASE = 10000;
        public const int LOCK_NUMBER_MUL = 10;

        public LFloat(float val)
        {
            float fVal = val * MAX_BASE;
            int iVal = (int)fVal;
            int value = iVal / LOCK_NUMBER_MUL;
            this._val = value;
        }
        ...
        public static LFloat operator *(LFloat a, LFloat b)
        {
            ...
            LFloat result = new LFloat(true, (int)(val / 1000));
            return result;
        }
