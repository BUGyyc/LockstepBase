 ...
 * @Last Modified time: 2022-11-26 15:48:07
 */
    ...
    public struct FixMatrix
    {
        ...
        public static FixMatrix Identity
        {
            get
            {
                ...
                result.M11 = FixFloat64Util.C1;
                result.M12 = FixFloat64Util.C0;
                result.M13 = FixFloat64Util.C0;
                result.M14 = FixFloat64Util.C0;
                result.M21 = FixFloat64Util.C0;
                result.M22 = FixFloat64Util.C1;
                result.M23 = FixFloat64Util.C0;
                result.M24 = FixFloat64Util.C0;
                result.M31 = FixFloat64Util.C0;
                result.M32 = FixFloat64Util.C0;
                result.M33 = FixFloat64Util.C1;
                result.M34 = FixFloat64Util.C0;
                result.M41 = FixFloat64Util.C0;
                result.M42 = FixFloat64Util.C0;
                result.M43 = FixFloat64Util.C0;
                result.M44 = FixFloat64Util.C1;
                return result;
            }
        }
        ...
        public static void CreateFromAxisAngle(ref FixVector3 axis, FixFloat64 angle, out FixMatrix result)
        {
            ...
            FixFloat64 fix8 = FixFloat64Util.C1 - FixFloat64.Cos(angle);
            result.M11 = FixFloat64Util.C1 + fix8 * (fix - FixFloat64Util.C1);
            result.M21 = -axis.Z * fix7 + fix8 * fix4;
            result.M31 = axis.Y * fix7 + fix8 * fix5;
            result.M41 = FixFloat64Util.C0;
            result.M12 = axis.Z * fix7 + fix8 * fix4;
            result.M22 = FixFloat64Util.C1 + fix8 * (fix2 - FixFloat64Util.C1);
            result.M32 = -axis.X * fix7 + fix8 * fix6;
            result.M42 = FixFloat64Util.C0;
            result.M13 = -axis.Y * fix7 + fix8 * fix5;
            result.M23 = axis.X * fix7 + fix8 * fix6;
            result.M33 = FixFloat64Util.C1 + fix8 * (fix3 - FixFloat64Util.C1);
            result.M43 = FixFloat64Util.C0;
            result.M14 = FixFloat64Util.C0;
            result.M24 = FixFloat64Util.C0;
            result.M34 = FixFloat64Util.C0;
        ...
        public static void InvertRigid(ref FixMatrix m, out FixMatrix inverted)
        {
            ...
            inverted.M14 = FixFloat64Util.C0;
            inverted.M24 = FixFloat64Util.C0;
            inverted.M34 = FixFloat64Util.C0;
            inverted.M44 = FixFloat64Util.C1;
        }
        ...
        public static void CreateOrthographicRH(FixFloat64 left, FixFloat64 right, FixFloat64 bottom, FixFloat64 top, FixFloat64 zNear, FixFloat64 zFar, out FixMatrix projection)
        {
            ...
            projection.M11 = FixFloat64Util.C2 / fix;
            projection.M12 = FixFloat64Util.C0;
            projection.M13 = FixFloat64Util.C0;
            projection.M14 = FixFloat64Util.C0;
            projection.M21 = FixFloat64Util.C0;
            projection.M22 = FixFloat64Util.C2 / fix2;
            projection.M23 = FixFloat64Util.C0;
            projection.M24 = FixFloat64Util.C0;
            projection.M31 = FixFloat64Util.C0;
            projection.M32 = FixFloat64Util.C0;
            projection.M33 = -1 / fix3;
            projection.M34 = FixFloat64Util.C0;
            projection.M41 = (left + right) / -fix;
            projection.M42 = (top + bottom) / -fix2;
            projection.M43 = zNear / -fix3;
            projection.M44 = FixFloat64Util.C1;
        }
        ...
        {
            FixFloat64 fix = FixFloat64Util.C1 / FixFloat64.Tan(fieldOfView / FixFloat64Util.C2);
            FixFloat64 fix2 = (perspective.M11 = fix / aspectRatio);
            perspective.M12 = FixFloat64Util.C0;
            perspective.M13 = FixFloat64Util.C0;
            perspective.M14 = FixFloat64Util.C0;
            perspective.M21 = FixFloat64Util.C0;
            perspective.M22 = fix;
            perspective.M23 = FixFloat64Util.C0;
            perspective.M24 = FixFloat64Util.C0;
            perspective.M31 = FixFloat64Util.C0;
            perspective.M32 = FixFloat64Util.C0;
            perspective.M33 = farClip / (nearClip - farClip);
            perspective.M34 = -1;
            perspective.M41 = FixFloat64Util.C0;
            perspective.M42 = FixFloat64Util.C0;
            perspective.M44 = FixFloat64Util.C0;
        ...
        public static void CreateViewRH(ref FixVector3 position, ref FixVector3 forward, ref FixVector3 upVector, out FixMatrix viewMatrix)
        {
            ...
            viewMatrix.M44 = FixFloat64Util.C1;
        }
        ...
        public static void CreateTranslation(ref FixVector3 translation, out FixMatrix translationMatrix)
        {
            ...
            {
                M11 = FixFloat64Util.C1,
                M22 = FixFloat64Util.C1,
                M33 = FixFloat64Util.C1,
                M44 = FixFloat64Util.C1,
                M41 = translation.X,
                M42 = translation.Y,
                M43 = translation.Z
            };
