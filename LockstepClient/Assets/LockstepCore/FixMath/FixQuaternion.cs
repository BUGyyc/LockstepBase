 ...
 * @Last Modified time: 2022-11-28 17:54:45
 */
...
namespace FixMath
{
    ...
    public struct FixQuaternion : IEquatable<FixQuaternion>
    {
        ...
        /// </summary>
        public static FixQuaternion Identity => new FixQuaternion(FixFloat64.C0, FixFloat64.C0, FixFloat64.C0, FixFloat64.C1);
        ...
        public static void CreateFromRotationMatrix(ref FixMatrix3x3 r, out FixQuaternion q)
        {
            ...
            {
                FixFloat64 fix2 = FixFloat64.Sqrt(fix + FixFloat64.C1) * FixFloat64.C2;
                FixFloat64 fix3 = FixFloat64.C1 / fix2;
                q.W = FixFloat64.C0p25 * fix2;
            ...
            {
                FixFloat64 fix4 = FixFloat64.Sqrt(FixFloat64.C1 + r.M11 - r.M22 - r.M33) * FixFloat64.C2;
                FixFloat64 fix5 = FixFloat64.C1 / fix4;
                q.W = (r.M23 - r.M32) * fix5;
                q.X = FixFloat64.C0p25 * fix4;
                q.Y = (r.M21 + r.M12) * fix5;
                q.Z = (r.M31 + r.M13) * fix5;
            }
            else if (r.M22 > r.M33)
            {
                FixFloat64 fix6 = FixFloat64.Sqrt(FixFloat64.C1 + r.M22 - r.M11 - r.M33) * FixFloat64.C2;
                FixFloat64 fix7 = FixFloat64.C1 / fix6;
                q.W = (r.M31 - r.M13) * fix7;
                q.X = (r.M21 + r.M12) * fix7;
                q.Y = FixFloat64.C0p25 * fix6;
                q.Z = (r.M32 + r.M23) * fix7;
            }
            else
            {
                FixFloat64 fix8 = FixFloat64.Sqrt(FixFloat64.C1 + r.M33 - r.M11 - r.M22) * FixFloat64.C2;
                FixFloat64 fix9 = FixFloat64.C1 / fix8;
                q.W = (r.M12 - r.M21) * fix9;
                q.X = (r.M31 + r.M13) * fix9;
                q.Y = (r.M32 + r.M23) * fix9;
                q.Z = FixFloat64.C0p25 * fix8;
            }
        }
        ...
        {
            FixFloat64 fix = FixFloat64.C1 / FixFloat64.Sqrt(quaternion.X * quaternion.X + quaternion.Y * quaternion.Y + quaternion.Z * quaternion.Z + quaternion.W * quaternion.W);
        ...
        public static void Slerp(ref FixQuaternion start, ref FixQuaternion end, FixFloat64 interpolationAmount, out FixQuaternion result)
        {
            ...
            FixFloat64 fix3 = FixFloat64.Sqrt(FixFloat64.C1 - fix * fix);
            FixFloat64 fix4 = FixFloat64.Sin((FixFloat64.C1 - interpolationAmount) * fix2) / fix3;
        ...
        public static void Transform(ref FixVector3 v, ref FixQuaternion rotation, out FixVector3 result)
        {
            ...
            FixFloat64 x = v.X * (FixFloat64.C1 - fix7 - fix9) + v.Y * (fix5 - fix12) + v.Z * (fix6 + fix11);
            FixFloat64 y = v.X * (fix5 + fix12) + v.Y * (FixFloat64.C1 - fix4 - fix9) + v.Z * (fix8 - fix10);
            FixFloat64 z = v.X * (fix6 - fix11) + v.Y * (fix8 + fix10) + v.Z * (FixFloat64.C1 - fix4 - fix7);
            result.X = x;
            result.Y = y;
            result.Z = z;
        }
        ...
        public static void TransformX(FixFloat64 x, ref FixQuaternion rotation, out FixVector3 result)
        {
            ...
            FixFloat64 x2 = x * (FixFloat64.C1 - fix5 - fix6);
        ...
        public static void TransformY(FixFloat64 y, ref FixQuaternion rotation, out FixVector3 result)
        {
            ...
            FixFloat64 y2 = y * (FixFloat64.C1 - fix4 - fix7);
        ...
        public static void TransformZ(FixFloat64 z, ref FixQuaternion rotation, out FixVector3 result)
        {
            ...
            FixFloat64 z2 = z * (FixFloat64.C1 - fix4 - fix6);
            result.X = x;
            result.Y = y;
            result.Z = z2;
        }
        ...
        {
            FixFloat64 x = angle * FixFloat64.C0p5;
        ...
        {
            FixFloat64 x = roll * FixFloat64.C0p5;
            FixFloat64 x2 = pitch * FixFloat64.C0p5;
            FixFloat64 x3 = yaw * FixFloat64.C0p5;
            FixFloat64 fix = FixFloat64.Sin(x);
        ...
        public static FixFloat64 GetAngleFromQuaternion(ref FixQuaternion q)
        {
            ...
            if (fix > FixFloat64.C1)
            {
                return FixFloat64.C0;
            }
            return FixFloat64.C2 * FixFloat64.Acos(fix);
        }
        ...
        public static void GetAxisAngleFromQuaternion(ref FixQuaternion q, out FixVector3 axis, out FixFloat64 angle)
        {
            ...
            if (fix2 > FixFloat64.C1em14)
            {
                FixVector3.Divide(ref axis, FixFloat64.Sqrt(fix2), out axis);
                angle = FixFloat64.C2 * FixFloat64.Acos(MathHelper.Clamp(fix, (FixFloat64)(-1), FixFloat64.C1));
            }
            else
            {
                axis = FixVector3.Up;
        ...
        public static void GetQuaternionBetweenNormalizedVectors(ref FixVector3 v1, ref FixVector3 v2, out FixQuaternion q)
        {
            ...
            if (product < FixFloat64.Cm0p9999)
            {
                ...
                {
                    q = new FixQuaternion(FixFloat64.C0, -v1.Z, v1.Y, FixFloat64.C0);
                }
                else if (fix2 < fix3)
                {
                    q = new FixQuaternion(-v1.Z, FixFloat64.C0, v1.X, FixFloat64.C0);
                }
                else
                {
                    q = new FixQuaternion(-v1.Y, v1.X, FixFloat64.C0, FixFloat64.C0);
                }
            }
            else
            {
                FixVector3.Cross(ref v1, ref v2, out var result);
                q = new FixQuaternion(result.X, result.Y, result.Z, product + FixFloat64.C1);
            }
            q.Normalize();
        }
