 ...
 * @Last Modified time: 2022-11-26 15:26:17
 */
...
namespace FixMath
{
    ...
    public struct FixVector4 : IEquatable<FixVector4>
    {
        ...
        {
            FixFloat64 fix = FixFloat64Util.C1 / divisor;
            result.X = v.X * fix;
            result.Y = v.Y * fix;
            result.Z = v.Z * fix;
            result.W = v.W * fix;
        ...
        {
            FixFloat64 fix = FixFloat64Util.C1 / FixFloat64.Sqrt(v.X * v.X + v.Y * v.Y + v.Z * v.Z + v.W * v.W);
            result.X = v.X * fix;
            result.Y = v.Y * fix;
            result.Z = v.Z * fix;
            result.W = v.W * fix;
        ...
        {
            FixFloat64 fix = FixFloat64Util.C1 - interpolationAmount;
        ...
        public static void Hermite(ref FixVector4 value1, ref FixVector4 tangent1, ref FixVector4 value2, ref FixVector4 tangent2, FixFloat64 interpolationAmount, out FixVector4 result)
        {
            ...
            FixFloat64 fix3 = FixFloat64Util.C2 * fix2 - FixFloat64Util.C3 * fix + FixFloat64Util.C1;
            FixFloat64 fix4 = fix2 - FixFloat64Util.C2 * fix + interpolationAmount;
            FixFloat64 fix5 = -2 * fix2 + FixFloat64Util.C3 * fix;
