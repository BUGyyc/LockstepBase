...
namespace FixMath
{
    ...
    public struct FixMatrix3x3
    {
        ...
        /// </summary>
        public static FixMatrix3x3 Identity => new FixMatrix3x3(FixFloat64Util.C1, FixFloat64Util.C0, FixFloat64Util.C0, FixFloat64Util.C0, FixFloat64Util.C1, FixFloat64Util.C0, FixFloat64Util.C0, FixFloat64Util.C0, FixFloat64Util.C1);
        ...
        {
            result.M11 = FixFloat64Util.C0;
            result.M12 = -v.Z;
            result.M13 = v.Y;
            result.M21 = v.Z;
            result.M22 = FixFloat64Util.C0;
            result.M23 = -v.X;
            result.M31 = -v.Y;
            result.M32 = v.X;
            result.M33 = FixFloat64Util.C0;
        }
        ...
        public static void AdaptiveInvert(ref FixMatrix3x3 matrix, out FixMatrix3x3 result)
        {
            ...
            {
                int subMatrixCode;
                FixFloat64 fix = FixFloat64Util.C1 / matrix.AdaptiveDeterminant(out subMatrixCode);
                FixFloat64 m;
                FixFloat64 m2;
                FixFloat64 m3;
                FixFloat64 m4;
                ...
                switch (subMatrixCode)
                {
                    case 1:
                        m = matrix.M22 * fix;
                        m2 = -matrix.M12 * fix;
                        m3 = FixFloat64Util.C0;
                        m4 = -matrix.M21 * fix;
                        m5 = matrix.M11 * fix;
                        m6 = FixFloat64Util.C0;
                        m7 = FixFloat64Util.C0;
                        m8 = FixFloat64Util.C0;
                        m9 = FixFloat64Util.C0;
                        break;
                    case 2:
                        m = FixFloat64Util.C0;
                        m2 = FixFloat64Util.C0;
                        m3 = FixFloat64Util.C0;
                        m4 = FixFloat64Util.C0;
                        m5 = matrix.M33 * fix;
                        m6 = -matrix.M23 * fix;
                        m7 = FixFloat64Util.C0;
                        m8 = -matrix.M32 * fix;
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        m = FixFloat64Util.C1 / matrix.M11;
                        m2 = FixFloat64Util.C0;
                        m3 = FixFloat64Util.C0;
                        m4 = FixFloat64Util.C0;
                        m5 = FixFloat64Util.C0;
                    ...
                    case 5:
                        ...
                        m3 = FixFloat64Util.C0;
                        m4 = FixFloat64Util.C0;
                        m5 = FixFloat64Util.C1 / matrix.M22;
                        m6 = FixFloat64Util.C0;
                        m7 = FixFloat64Util.C0;
                        m8 = FixFloat64Util.C0;
                        m9 = FixFloat64Util.C0;
                    ...
                    case 6:
                        ...
                        m7 = FixFloat64Util.C0;
                        m8 = FixFloat64Util.C0;
                        m9 = FixFloat64Util.C1 / matrix.M33;
                        break;
                    default:
                        m = FixFloat64Util.C0;
                        m2 = FixFloat64Util.C0;
        ...
        public static void ToMatrix4X4(ref FixMatrix3x3 a, out FixMatrix b)
        {
            ...
            b.M32 = a.M32;
            b.M33 = a.M33;
            b.M44 = FixFloat64Util.C1;
            b.M14 = FixFloat64Util.C0;
            b.M24 = FixFloat64Util.C0;
            b.M34 = FixFloat64Util.C0;
            b.M41 = FixFloat64Util.C0;
            b.M42 = FixFloat64Util.C0;
            b.M43 = FixFloat64Util.C0;
        }
        ...
        internal FixFloat64 AdaptiveDeterminant(out int subMatrixCode)
        {
            ...
            if (M11 != FixFloat64Util.C0)
            {
                subMatrixCode = 4;
                return M11;
            }
            if (M22 != FixFloat64Util.C0)
            {
                subMatrixCode = 5;
                return M22;
            }
            if (M33 != FixFloat64Util.C0)
            {
                subMatrixCode = 6;
                return M33;
            }
