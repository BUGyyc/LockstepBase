...
namespace BM
{
    public class BuildAssets : EditorWindow
    {
        ...
        public static void BuildAllBundle()
        {
            ...
            AssetLogHelper.Log("打包结束, 耗时" + sw.Elapsed.TotalMilliseconds + " ms      " + assetLoadTable.BuildBundlePath);
        }
        ...
        /// 构建AB包
        /// </summary>
        /// <param name="assetLoadTable"></param>
        /// <param name="assetsLoadSetting"></param>
        /// <param name="assetLoadPath"></param>
        /// <param name="alwaysIncludedShaders"></param>
