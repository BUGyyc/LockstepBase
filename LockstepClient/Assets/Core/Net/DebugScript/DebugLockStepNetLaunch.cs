...
public class DebugLockStepNetLaunch : MonoBehaviour
{
    ...
    public GameObject clientIntObj;
    ...
    private void StartServer()
    {
        ...
        if (containerObj.GetComponent<LockstepServer>() != null) return;
    ...
    private void StartClient()
    {
        ...
        if (containerObj.GetComponent<LockstepClient>() != null) return;


        var gc = containerObj.AddComponent<LockstepClient>();
